...
export default function AboutHeading() {
  ...
  return (
    <div className="relative w-full">
      <div className="flex flex-col lg:flex-row justify-between w-full gap-6 2xl:gap-[8rem] lg:gap-[1.5rem]">
        <div className="h-full w-full lg:w-[71%] flex flex-col lg:items-end gap-[1rem]">
          <div ref={ref}>
            <motion.div
              ...
              className="w-[60%] h-full sm:w-[38%] md:w-[32%] lg:w-[15rem] xl:w-[20vw] 2xl:w-[25rem] lg:pt-[1rem]"
            >
              <motion.div
                initial={{ scale: 1.5 }}
